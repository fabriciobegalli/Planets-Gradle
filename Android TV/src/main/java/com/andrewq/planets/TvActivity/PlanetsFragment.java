...
public class PlanetsFragment extends BrowseFragment {
    ...
    private void loadRows() {
        List<Planet> list = PlanetsList.setupPlanets();
        ...
        for (i = 0; i < NUM_ROWS; i++) {
            ...
            HeaderItem header = new HeaderItem(i, PlanetsList.MOVIE_CATEGORY[i], null);
            mRowsAdapter.add(new ListRow(header, listRowAdapter));
        }

        HeaderItem gridHeader = new HeaderItem(i, null, null);
