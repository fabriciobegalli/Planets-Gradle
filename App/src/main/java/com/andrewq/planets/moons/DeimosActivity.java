...
public class DeimosActivity extends BaseActivity implements ObservableScrollViewCallbacks {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.deimos_activity);

        toolbar = (Toolbar) findViewById(R.id.toolbar_deimos);
