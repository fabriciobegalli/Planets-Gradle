...
public class MoonActivity extends Activity {
    ...
    //opens an email intent with a screenshot and preloaded email
    {
        ...
        emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Feedback: The Moon");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (isChecked) {
            mActionBar.setCustomView(R.layout.custom_actionbar_moon_noback);
        ...
        if (theme_chooser == 1) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                this.setTaskDescription(new ActivityManager.TaskDescription("The Moon",
