...
public class PhobosActivity extends BaseActivity implements ObservableScrollViewCallbacks {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.phobos_activity);

        toolbar = (Toolbar) findViewById(R.id.toolbar_phobos);
