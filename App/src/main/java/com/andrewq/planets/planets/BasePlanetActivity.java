...
public abstract class BasePlanetActivity extends BaseActivity implements ObservableScrollViewCallbacks {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.toolbar_earth);
    ...
    public abstract String taskDescriptionName(String taskName);
