...
public class NeptuneActivity extends BaseActivity implements ObservableScrollViewCallbacks {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.toolbar_neptune);
        ...
        if (theme_chooser == 1) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                this.setTaskDescription(new ActivityManager.TaskDescription("Neptune",
