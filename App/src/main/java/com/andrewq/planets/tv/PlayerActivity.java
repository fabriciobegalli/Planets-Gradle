...
public class PlayerActivity extends Activity {
    ...
    private void startVideoPlayer() {
        ...
        mSelectedPlanet = (Planet) getIntent().getSerializableExtra(getResources().getString(R.string.movie));
        if (null != b) {
        ...
        public void run() {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    intent.putExtra(getResources().getString(R.string.movie), mSelectedPlanet);
