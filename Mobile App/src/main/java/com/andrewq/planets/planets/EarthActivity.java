...
public class EarthActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mActionBar.setCustomView(R.layout.custom_actionbar_earth);
        ...
        ((NotifyingScrollView) findViewById(R.id.scroll_view_4)).setOnScrollChangedListener(mOnScrollChangedListener);

        imgV = (ImageView) findViewById(R.id.image_header_earth);
        ...
        View.OnTouchListener upDownListener = new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    imgV.setAlpha(1.0f);
                    Intent i = new Intent(getBaseContext(), EarthImageView.class);
    ...
    //opens an email intent with a screenshot and preloaded email
    {
        ...
        emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Feedback: Earth");
    ...
    //takes a screenshot and stores it in the app's cache, returns the image
    {
        ...
        try {
            ...
            File imageFile = File.createTempFile("pfb_earth", ".jpeg", outputDir);
    ...
    private NotifyingScrollView.OnScrollChangedListener mOnScrollChangedListener = new NotifyingScrollView.OnScrollChangedListener() {
        public void onScrollChanged(ScrollView who, int l, int t, int oldl, int oldt) {
            final int headerHeight = findViewById(R.id.image_header_earth).getHeight() - getActionBar().getHeight();
