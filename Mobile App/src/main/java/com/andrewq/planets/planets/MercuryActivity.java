...
import com.andrewq.planets.image_views.MercuryImageView;
...
public class MercuryActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mActionBar.setCustomView(R.layout.custom_actionbar_mercury);
        ...
        ((NotifyingScrollView) findViewById(R.id.scroll_view_2)).setOnScrollChangedListener(mOnScrollChangedListener);
    ...
    //opens an email intent with a screenshot and preloaded email
    {
        ...
        emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Feedback: Mercury");
    ...
    //takes a screenshot and stores it in the app's cache, returns the image
    {
        ...
        try {
            ...
            File imageFile = File.createTempFile("pfb_mercury", ".jpeg", outputDir);
