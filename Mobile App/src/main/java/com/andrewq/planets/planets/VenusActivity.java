...
import com.andrewq.planets.image_views.VenusImageView;
...
public class VenusActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.venus_activity);
        ...
        ((NotifyingScrollView) findViewById(R.id.scroll_view_3)).setOnScrollChangedListener(mOnScrollChangedListener);
        ...
        View.OnTouchListener upDownListener = new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    imgV.setAlpha(1.0f);
                    Intent i = new Intent(getBaseContext(), VenusImageView.class);
    ...
    //opens an email intent with a screenshot and preloaded email
    {
        ...
        emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Feedback: Venus");
    ...
    //takes a screenshot and stores it in the app's cache, returns the image
    {
        ...
        try {
            ...
            File imageFile = File.createTempFile("pfb_venus", ".jpeg", outputDir);
    ...
    private NotifyingScrollView.OnScrollChangedListener mOnScrollChangedListener = new NotifyingScrollView.OnScrollChangedListener() {
        public void onScrollChanged(ScrollView who, int l, int t, int oldl, int oldt) {
            @SuppressWarnings("ConstantConditions") final int headerHeight = findViewById(R.id.image_header_venus).getHeight() - getActionBar().getHeight();
